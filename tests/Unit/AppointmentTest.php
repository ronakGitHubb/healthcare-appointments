...
use Laravel\Passport\ClientRepository; // Make sure this is imported
...
class AppointmentTest extends TestCase
{
    ...
    public function test_can_book_an_appointment_successfully()
    {
        ...
        $response = $this->postJson('/api/book', $appointmentData);
    ...
    /**
     * Test booking an appointment with a conflict.
     *
     * @return void
     */
    public function test_cannot_book_an_appointment_with_conflict()
    {
        $user = User::factory()->create();
        Passport::actingAs($user);
    ...
    public function test_can_cancel_an_appointment()
    {
        ...
        $response = $this->deleteJson("/api/cancel/{$appointment->id}");
